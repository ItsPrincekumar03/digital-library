...
-- =====================================================
-- 12. reading_progress (one record per user/book)
-- =====================================================
...
-- =====================================================
-- 14. reader_settings (one record per user)
-- =====================================================
CREATE TABLE reader_settings (
    setting_id  BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    user_id     BIGINT UNSIGNED NOT NULL,
    theme       ENUM('LIGHT','DARK','SEPIA') NOT NULL DEFAULT 'LIGHT',
    font_size   INT UNSIGNED NOT NULL DEFAULT 16,
    preferences JSON NULL,
    updated_at  DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
                   ON UPDATE CURRENT_TIMESTAMP,

    CONSTRAINT uq_reader_settings_user UNIQUE (user_id),
...
CREATE TABLE audit_logs (
    ...
    user_id     BIGINT UNSIGNED NOT NULL,
    action      ENUM(
                    'BOOK_CREATED','BOOK_APPROVED','BOOK_REJECTED',
                    'BOOK_PUBLISHED','BOOK_ARCHIVED',
